...
<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	...
	<div class="extra">
		<ul class="list-unstyled">
			<li>
				<a href="./editar?trabalho=<?php the_ID(); ?>"><i class="icon dm-editar" data-toggle="tooltip" data-placement="right" title="Editar"></i></a>
			</li>
			<li>
				<?php $nonce = wp_create_nonce('dm_remove_work_nonce') ?>
				<a class="md-trigger" data-modal="modal-rw" data-id="<?php the_ID() ?>" data-nonce="<?php echo $nonce ?>"><i class="icon dm-apagar" data-toggle="tooltip" data-placement="right" title="Apagar"></i></a>
			</li>
		</ul>
	</div>
	<!-- /post edit-->
